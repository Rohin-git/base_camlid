...
class RelativePoseNet(BaseNet, ABC):
    ...
    def __init__(self, cfg):
        ...
        scenario_ids = self._get_scenario_from_dirlist(
            cfg.search_scenario_from_path, cfg_has(cfg,"remove_scenario", []))  # [["000150"], ["000151"], ..., ]
        ...
        self.with_offset = cfg_has(cfg,'add_shared_bias', False)
        init_std = cfg_has(cfg,'init_std', 0)
